...
namespace VideoSearch
{
    class WebConstant
    {
        ...
        public static string viewModel = "<li class='content'>{name}<span><a href='/play?url={url}&model=0'>打开(自动)</a>--<a href='/play?url={url}&model=1'>打开(强制)</a>--<a href='{url}'>打开(直接)</a></span></li>";
